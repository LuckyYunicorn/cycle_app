...
class CustomNavBar {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage(ImageConstants.imgBottomNavBg),
              fit: BoxFit.fill,
            ),
          ),
          child: Row(
  ...
  Widget navBarButton({
    ...
    List<String> tabIconList = [
      IconConstants.icBicycle,
      IconConstants.icMap,
      IconConstants.icCart,
      IconConstants.icPerson,
      IconConstants.icDoc,
    ];
    return Expanded(
      flex: 1,
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(
                bottom: currentIndex == index ? 45.h : 10,
                right: 10.w,
              ),
              child: CommonWidgets.appIcons(
                assetName: tabIconList[index],
                height: 20.h,
                width: 20.w,
              ),
            ),
