  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) =>
          OrderHistoryBloc()..add(OrderHistoryLoaded()),
        ...
        child: BlocBuilder<OrderHistoryBloc, OrderHistoryState>(
          builder: (context, state) {
            return Scaffold(
              ...
              body: state.orderHistoryList.isNotEmpty
                  ? Column(
                      children: [
                        ListView.builder(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                item.title,
                                                style:
                                                    AppTextStyle.titleStyle16bw,
                                              ),
                                              Text(
                                                '\$ ${item.price}',
                                                style:
                                                    AppTextStyle.titleStyle14gr,
                                              ),
                                              Text(
                                                'Completed',
                                                style:
                                                    AppTextStyle.titleStyle14bw,
                                              ),
                                            ],
                                          ),
                                        ),
